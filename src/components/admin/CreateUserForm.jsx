...
const CreateUserForm = () => {
  ...
  return (
    <div className="rounded-xl border border-emerald-500/40 bg-slate-100 bg-slate-900/80 p-4 space-y-3">
      ...
      <form className="space-y-3">
        ...
        disabled={role === "admin"}
        className={`w-full px-3 py-2 rounded-lg bg-slate-50 bg-slate-950 border border-slate-300 border-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 
